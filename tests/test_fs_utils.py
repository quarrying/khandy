...
class TestEscapeFilename(unittest.TestCase):
    """Unit tests for fs_utils.khandy.sanitize_filename"""

    def test_normal_filename(self):
        """Test that a normal filename remains unchanged."""
        self.assertEqual(khandy.sanitize_filename("normal_file.txt"), "normal_file.txt")
        self.assertEqual(khandy.sanitize_filename("normal file.txt"), "normal file.txt")

    def test_replace_backslash(self):
        """Test replacement of backslash."""
        filename = "file\\name.txt"
        result = khandy.sanitize_filename(filename)
    ...
    def test_custom_replacement_char(self):
        ...
        filename = "file/name.txt"
        result = khandy.sanitize_filename(filename, new_char="-")
