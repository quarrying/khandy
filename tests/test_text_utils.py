...
class TestSplitBeforeAfter(unittest.TestCase):
    def test_split_before_after_when_not_stripping(self):
        self.assertEqual(split_before_after('entity'), ('entity', None))
        self.assertEqual(split_before_after('entity$subset'), ('entity', 'subset'))
        self.assertEqual(split_before_after('$subset'), ('', 'subset'))
        self.assertEqual(split_before_after(''), ('', None))
        self.assertEqual(split_before_after('entity$ '), ('entity', ' '))
        self.assertEqual(split_before_after(' $subset'), (' ', 'subset'))
        self.assertEqual(split_before_after('entity $subset'), ('entity ', 'subset'))

        self.assertEqual(split_before_after('entity$'), ('entity', ''))
        self.assertEqual(split_before_after('$'), ('', ''))
        with self.assertRaises(ValueError):
            split_before_after('invalid$format$here')
