...
def split_before_after(
    ...
    Returns:
        Tuple[str, Optional[str]]: A tuple (before, after). If a second part is empty, it will be None.

    Raises:
        ValueError: If the string contains more than one separator.
    """
    ...
    before_part = parts[0]
    after_part = parts[1] if len(parts) == 2 else None
